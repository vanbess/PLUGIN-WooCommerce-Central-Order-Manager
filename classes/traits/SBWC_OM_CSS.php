    ...
    trait SBWC_OM_CSS {
        ...
        public static function sbwc_om_css() {
            ...
            <style>
                ...
                #sbwc-om-all-order-details {
                    width: 37%;
                    float: left;
                }
                #sbwc-om-all-order-products {
                    float: right;
                    width: 61%;
                }
                #sbwc-all-order-modal-proper > h3 > a {
                    display: block;
                    width: 25px;
                    height: 25px;
                    text-decoration: none;
                ...
                #sbwc-om-all-order-details-table > tbody > tr > th {
                    background: #efefef;
                    padding: 10px 15px;
                }
                #sbwc-om-all-order-product-data > thead > tr > th {
                    background: #efefef;
                    padding: 10px 15px;
                }
                #sbwc-om-all-order-details-table > tbody > tr > td {
                    border: 1px solid #ddd;
                    padding: 10px 15px;
                }
                #sbwc-all-order-modal-proper > h3 {
                    margin-top: 5px;
                }
                #sbwc-om-all-order-product-dataset > tr > td {
                    border: 1px solid #ddd;
                    padding: 10px 15px;
                }
            </style>
